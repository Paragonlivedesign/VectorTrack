...
| File | What it is |
|------|------------|
| **`VectorTrack-0.5.7-Setup.exe`** | **Recommended.** Installs the desktop app with Start Menu shortcut and uninstaller. |
...
1. Download **`VectorTrack-0.5.7-Setup.exe`** from [Latest Release](https://github.com/Paragonlivedesign/VectorTrack/releases/latest).
