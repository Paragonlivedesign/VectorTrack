# Copy VectorTrack 0.5 sources and build to _2 Beta Testing.
...
$standaloneSrc = $root
$standaloneDst = Join-Path $betaRoot "VectorTrack 0.5"
$scriptSrc = Join-Path (Split-Path $root -Parent) "VectorTrackScript 0.5"
$scriptDst = Join-Path $betaRoot "VectorTrackScript 0.5"
